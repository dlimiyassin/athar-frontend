...
@Component({
    ...
    styles: [`
            ...
            border-top: 4px solid #0fbbe2; /* Blue */
            border-radius: 50%;
            width: 20px;
            height: 20px;
        ...
        <div class="bg-surface-50 dark:bg-surface-950 pt-0 md:pt-8 flex items-center justify-center max-h-screen min-w-screen overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 56px; padding: 0.2rem 0.2rem 0 0.2rem; background: linear-gradient(180deg, #059669 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-white dark:bg-surface-900 p-8 sm:px-20"
                        ...
                        <div class="text-center mb-3">
                            <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-4 w-16 shrink-0 mx-auto">
                                ...
                                <mask id="mask0_1413_1551" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8" width="54" height="11">
                                    <path d="M27 18.3652C10.5114 19.1944 0 8.88892 0 8.88892C0 8.88892 16.5176 14.5866 27 14.5866C37.4824 14.5866 54 8.88892 54 8.88892C54 8.88892 43.4886 17.5361 27 18.3652Z" fill="#059669" />
                                </mask>
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-2xl font-medium mb-3">Welcome to ATHAR!</div>
                            <span class="text-muted-color font-medium">Sign in to continue</span>
                        </div>

                        <div class="scale-90 w-full max-w-md">
                            ...
                            <label
                                for="password"
                                class="block text-surface-900 dark:text-surface-0 font-medium text-sm mb-2">
                                Password
                            </label>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-6 gap-8">
                                ...
                                <a
                                    ...
                                    class="font-medium text-sm cursor-pointer text-primary">
                                    Forgot password?
                                </a>
                            </div>
...
export class LoginPage {
    ...
    validLoginEmail: boolean = true;
    validLoginPassword: boolean = true;
    ...
    validateEmail() {
        if (StringUtil.isEmpty(this.loginDto.email)) {
            this.validLoginEmail = false;
            this.errorMessages.push("Email is required");
        } else {
            this.validLoginEmail = true;
        }
    }

    validatePassword() {
        if (StringUtil.isEmpty(this.loginDto.password)) {
            this.validLoginPassword = false;
            this.errorMessages.push("Password is required");
        } else {
            this.validLoginPassword = true;
        }
