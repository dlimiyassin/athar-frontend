            ...
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 56px; padding: 0.2rem 0.2rem 0 0.2rem; background: linear-gradient(180deg, #059669 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-white dark:bg-surface-900 p-8 sm:px-20"
                        ...
                        <div class="scale-90">
                            <label for="email1" class="block text-surface-900 dark:text-surface-0 text-sm font-medium mb-2">Email</label>
                            <input pInputText id="email1" type="text" placeholder="Email address" class="w-full mb-4" [(ngModel)]="email" />
                            ...
                            <p-button class="bg-primary" label="Sign In" styleClass="w-full" routerLink="/"></p-button>
                        </div>
                    </div>
                </div>
            </div>
